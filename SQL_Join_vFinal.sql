...
This project joins the Customer Account and Customer Sales datasets using fuzzy match algorithym 
LEVENSCHTEIN function.
Step 1. Load in datasets
Step 2. Set up datasets
Step 3. Load LEVENSCHTEIN function
Step 4. Test function
Step 5. Join datasets using function
...
--------------------STEP 3. LOAD IN LEVENSCHTEIN FUNCTION--------------------
...
--------------------STEP 4. TEST LEVENSCHTEIN FUNCTION--------------------
--TEST---
...
-------------STEP 5. USE LEVENSCHTEIN FUNCTION TO JOIN DATSETS------------
